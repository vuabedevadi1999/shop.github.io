        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/insert-category-product')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="8" style="resize: none" class="form-control" name="category_roduct_des" id="exampleInputPassword1" placeholder="Password"></textarea>
                        </div>
                        <div class="form-group">
